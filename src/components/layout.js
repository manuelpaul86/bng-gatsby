...
const ListLink = props => (
  <li class="px-2 py-2 cursor-pointer hover:bg-green-300 hover:text-yellow-700">
...
export default function Layout({ children }) {
  return (
    <div class="w-screen min-h-screen mx-auto">
      <header>
        <div class="flex flex-row justify-between items-end bg-gray-50 shadow h-10 md:h-20 font-sans">
      ...
      <div class="md:mx-auto md:container min-h-screen py-6">
        {children}
      </div>
      <footer>
