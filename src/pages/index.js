  ...
  return (
    <Layout>
      <div class="grid grid-cols-4 gap-1">
        ...
        <div class="pt-2">
          <StaticImage src="../assets/CA_Meyer.jpg" alt="CA Hon. - Prof. Dr. Meyer" placeholder="none"></StaticImage>
        </div>
        <div class="pt-2 pl-2">
        ...
        <StaticImage src="../assets/unterschrift-meyer.png" alt="CA Hon. - Prof. Dr. Meyer" placeholder="none"></StaticImage>
        </div>
        <div class="col-span-4">
